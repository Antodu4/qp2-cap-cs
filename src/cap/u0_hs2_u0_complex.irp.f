subroutine u_0_HS2_u_0_complex(e_0,s_0,u_0,n,keys_tmp,Nint,N_st,sze)
  use bitmasks
  implicit none
  BEGIN_DOC
  ...
  do i=1,N_st
    ...
    if (norm /= 0.d0) then
      call inner_product_complex(v_0(1,i),u_0(1,i),n,res)
      e_0(i) = res/norm
      call inner_product_complex(s_vec(1,i),u_0(1,i),n,res)
      s_0(i) = res/norm
    else
      e_0(i) = (0.d0,0d0)
      s_0(i) = (0.d0,0d0)
